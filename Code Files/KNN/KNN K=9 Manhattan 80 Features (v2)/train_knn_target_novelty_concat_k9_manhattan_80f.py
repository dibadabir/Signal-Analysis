# ============================================================
# train_knn_target_novelty_concat_k9_manhattan_80f.py
# ============================================================
...
OUT_DIR = Path("outputs") / "knn_version_target_novelty_k9_manhattan_80f"
...
def main():
    ...
    report_path = OUT_DIR / "FINAL_REPORT_KNN_TARGET_NOVELTY_K9_MANHATTAN_80F.txt"
    ...
    config = {
        ...
        "version": "conservative_k9_manhattan_80f",
    }
