# ============================================================
# train_knn_target_novelty_concat.py
# ============================================================
...
OUT_DIR = Path("outputs") / "knn_version_target_novelty"
...
logger = logging.getLogger("train_knn_target_novelty")
...
def select_features_inside_fold(X_train, y_train, X_val, n_features=120):
    """
...
def main():
    ...
    report_path = OUT_DIR / "FINAL_REPORT_KNN_TARGET_NOVELTY.txt"
    with open(report_path, "w", encoding="utf-8") as f:
        ...
        f.write("=" * 80 + "\n\n")
        f.write(f"The KNN model achieved a mean accuracy of {mean_val_acc:.2%} across 5-fold\n")
        f.write(f"cross-validation, with ROC-AUC of {mean_val_auc:.3f}, using target + novelty\n")
        f.write(f"concatenated preprocessing.\n\n")
